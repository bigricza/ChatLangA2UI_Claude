...
import {
  ...
  trimLines,
  trough
} from "./chunk-G72OX5PG.js";
import {
  require_jsx_runtime
} from "./chunk-YPFTA7T3.js";
import {
  require_react_dom
} from "./chunk-RKPRDNAF.js";
import {
  require_react
...
var require_ansi_styles = __commonJS({
  "node_modules/chalk/node_modules/ansi-styles/index.js"(exports, module) {
    ...
    var colorConvert;
    var makeDynamicStyles = (wrap5, targetSpace, identity2, isBackground) => {
      ...
      for (const [sourceSpace, suite] of Object.entries(colorConvert)) {
        ...
        if (sourceSpace === targetSpace) {
          styles[name2] = wrap5(identity2, offset);
        } else if (typeof suite === "object") {
          styles[name2] = wrap5(suite[targetSpace], offset);
        }
      }
      return styles;
    };
...
// node_modules/@copilotkit/shared/dist/chunk-RBJMFH2X.mjs
var version = "1.51.3";
    ...
    OperationDefinition(node2) {
      if (node2.operation === "subscription") {
        ...
        if (subscriptionType) {
          ...
          for (const definition2 of document3.definitions) {
...
function ValuesOfCorrectTypeRule(context) {
  ...
  return {
    ...
    ObjectValue(node2) {
      ...
      if (type2.isOneOf) {
        validateOneOfInputObject(context, node2, type2, fieldNodeMap);
      }
    },
    ObjectField(node2) {
...
function validateOneOfInputObject(context, node2, type2, fieldNodeMap) {
...
// node_modules/@copilotkit/shared/dist/chunk-KFQ26VNX.mjs
...
var styledConsole = {
  ...
  /** Log an info message */
  info: (message2) => logStyled(`%cℹ️ ${message2}`, [ConsoleStyles.info]),
...
// node_modules/@copilotkit/shared/dist/chunk-64DYJ27R.mjs
...
function convertJsonSchemaToZodSchema(jsonSchema, required) {
  if (jsonSchema.type === "object") {
    ...
    if (!jsonSchema.properties || !Object.keys(jsonSchema.properties).length) {
      return !required ? external_exports.object(spec).optional() : external_exports.object(spec);
    }
    for (const [key, value2] of Object.entries(jsonSchema.properties)) {
      spec[key] = convertJsonSchemaToZodSchema(
        value2,
        jsonSchema.required ? jsonSchema.required.includes(key) : false
      );
    }
    let schema = external_exports.object(spec).describe(jsonSchema.description);
    return required ? schema : schema.optional();
  } else if (jsonSchema.type === "string") {
    let schema = external_exports.string().describe(jsonSchema.description);
    return required ? schema : schema.optional();
  } else if (jsonSchema.type === "number") {
    let schema = external_exports.number().describe(jsonSchema.description);
    return required ? schema : schema.optional();
  } else if (jsonSchema.type === "boolean") {
    let schema = external_exports.boolean().describe(jsonSchema.description);
    return required ? schema : schema.optional();
  } else if (jsonSchema.type === "array") {
    let itemSchema = convertJsonSchemaToZodSchema(jsonSchema.items, true);
    let schema = external_exports.array(itemSchema).describe(jsonSchema.description);
    return required ? schema : schema.optional();
  }
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/regex.js
var regex_default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;

// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/validate.js
function validate2(uuid) {
  return typeof uuid === "string" && regex_default.test(uuid);
}
var validate_default = validate2;

// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/parse.js
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/stringify.js
var byteToHex = [];
for (i3 = 0; i3 < 256; ++i3) {
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/rng.js
var getRandomValues;
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/v35.js
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/md5.js
function md5(bytes) {
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/v3.js
var v3 = v35("v3", 48, md5_default);

// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/native.js
var randomUUID = typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native_default = {
  randomUUID
};

// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/v4.js
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/sha1.js
function f(s, x, y2, z) {
  switch (s) {
    case 0:
      return x & y2 ^ ~x & z;
...
// node_modules/@copilotkit/shared/node_modules/uuid/dist/esm-browser/v5.js
var v5 = v35("v5", 80, sha1_default);
var v5_default = v5;

// node_modules/@copilotkit/shared/dist/chunk-BOKE4OKY.mjs
function randomId() {
...
function toSerializable(value2) {
  if (typeof value2 === "function") {
    return value2.toString();
  }
  if (Array.isArray(value2)) {
    return value2.map(toSerializable);
  }
  if (value2 !== null && typeof value2 === "object") {
    const result = {};
    for (const key of Object.keys(value2)) {
      result[key] = toSerializable(value2[key]);
    }
    return result;
  }
  return value2;
...
function dataToUUID(input, namespace) {
  ...
  return v5_default(stringInput, boundNamespace);
}
...
var CoreEventFactory = (
  ...
  (function() {
    ...
    CoreEventFactory2.prototype.alias = function(to, from2, options, integrationOptions) {
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-NHOKFX55.mjs
var Message = class {
  constructor(props) {
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-RNENVFJ3.mjs
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-EIPAWDCN.mjs
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-M5LBGBWO.mjs
var documents = {
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-3ETRQN2E.mjs
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-KTA7QTTU.mjs
...
var stringify3 = (e3, r2) => {
  if (null === e3 || i2.has(e3)) {
    return "null";
  } else if ("object" != typeof e3) {
    return JSON.stringify(e3) || "";
  } else if (e3.toJSON) {
    return stringify3(e3.toJSON(), r2);
  ...
  for (var v2 = 0, u3 = o2.length; v2 < u3; v2++) {
    var p2 = stringify3(e3[o2[v2]], r2);
    if (p2) {
      if (c2.length > 1) {
        c2 += ",";
      }
      c2 += stringify3(o2[v2], r2) + ":" + p2;
    }
  }
  i2.delete(e3);
  return c2 += "}";
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-QAHJHPE2.mjs
var version4 = "1.51.3";
...
// node_modules/@copilotkit/runtime-client-gql/dist/chunk-AMFKR5ST.mjs
...
var ExclamationMarkIcon = ({
  ...
  "svg",
  {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)("line", { x1: "12", x2: "12", y1: "8", y2: "12" }),
      (0, import_jsx_runtime.jsx)("line", { x1: "12", x2: "12.01", y1: "16", y2: "16" })
    ]
  }
);
...
function ToastProvider({
  ...
  return (0, import_jsx_runtime2.jsxs)(ToastContext.Provider, { value: value2, children: [
    bannerError && (() => {
...
// node_modules/@copilotkit/react-core/dist/chunk-6PUNP7CD.mjs
...
function compare(input, expect) {
  ...
  if (isB) expect = stringify4(expect);
  if (isA) input = stringify4(input);
...
function merge2(definitions3, space) {
  const property = {};
  const normal = {};
  let index3 = -1;
...
function ErrorToast({ errors }) {
  const errorsToRender = errors.map((error2, idx) => {
    ...
    return (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        children: [
          (0, import_jsx_runtime3.jsx)(ExclamationMarkIcon, { style: { marginBottom: 4 } }),
          code2 && (0, import_jsx_runtime3.jsxs)(
            "div",
            {
              style: {
                fontWeight: "600",
              ...
              children: [
                ...
                " ",
                (0, import_jsx_runtime3.jsx)("span", { style: { fontFamily: "monospace", fontWeight: "normal" }, children: code2 })
              ]
            }
          ),
          (0, import_jsx_runtime3.jsx)(ReactMarkdown, { children: message2 })
        ]
      },
      idx
    );
  ...
  return (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        errorsToRender,
        (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: "11px", opacity: 0.75 }, children: "NOTE: This error only displays during local development." })
      ]
    }
  );
}
  ...
  return (0, import_react4.useCallback)(
    (errors) => {
      ...
      addToast({
        ...
        message: (0, import_jsx_runtime3.jsx)(ErrorToast, { errors })
      });
    },
    [addToast]
  );
...
function UsageBanner({
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    (0, import_jsx_runtime4.jsx)("style", { children: `
        ...
        ` }),
    (0, import_jsx_runtime4.jsx)("div", { className: "usage-banner", children: (0, import_jsx_runtime4.jsxs)("div", { className: "banner-content", children: [
      (0, import_jsx_runtime4.jsx)("div", { className: "banner-message", children: message2 }),
      (actions == null ? void 0 : actions.primary) && (0, import_jsx_runtime4.jsx)("button", { className: "btn-primary", onClick: actions.primary.onClick, children: actions.primary.label }),
      onClose && (0, import_jsx_runtime4.jsx)("button", { className: "close-btn", onClick: onClose, title: "Close", children: "×" })
    ] }) })
  ] });
}
...
// node_modules/@copilotkit/react-core/dist/chunk-LHERIF3L.mjs
var import_react5 = __toESM(require_react(), 1);
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var statusChecker = new StatusChecker();
var CopilotErrorBoundary = class extends import_react5.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      hasError: false
    ...
    if (this.state.hasError) {
      if (this.state.error instanceof CopilotKitError) {
        return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
          this.props.children,
          this.props.showUsageBanner && (0, import_jsx_runtime5.jsx)(
            UsageBanner,
            {
...
// node_modules/@copilotkit/react-core/dist/chunk-AFNWX62Q.mjs
...
var CopilotContext = import_react6.default.createContext(emptyCopilotContext);
function useCopilotContext() {
  const context = import_react6.default.useContext(CopilotContext);
...
// node_modules/@copilotkit/react-core/dist/chunk-DMLQZG75.mjs
...
var CopilotMessagesContext = import_react7.default.createContext(emptyCopilotContext2);
function useCopilotMessagesContext() {
  const context = import_react7.default.useContext(CopilotMessagesContext);
...
// node_modules/@copilotkit/react-core/dist/chunk-HE22TZMF.mjs
var import_react8 = __toESM(require_react(), 1);
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var MessagesTapContext = (0, import_react8.createContext)(null);
function useMessagesTap() {
  const tap2 = (0, import_react8.useContext)(MessagesTapContext);
  if (!tap2)
...
function MessagesTapProvider({ children }) {
  ...
  const tapRef = (0, import_react8.useRef)({
    getMessagesFromTap: () => messagesRef.current,
    updateTapMessages: (messages) => {
      messagesRef.current = messages;
    }
  });
  return (0, import_jsx_runtime6.jsx)(MessagesTapContext.Provider, { value: tapRef.current, children });
}
function CopilotMessages({ children }) {
  const [messages, setMessages] = (0, import_react8.useState)([]);
  const lastLoadedThreadId = (0, import_react8.useRef)(void 0);
  const lastLoadedAgentName = (0, import_react8.useRef)(void 0);
  const lastLoadedMessages = (0, import_react8.useRef)(void 0);
  const { updateTapMessages } = useMessagesTap();
  const { threadId, agentSession, showDevConsole, onError, copilotApiConfig } = useCopilotContext();
  const { setBannerError } = useToast();
  const traceUIError = (0, import_react8.useCallback)(
  ...
  const handleGraphQLErrors = (0, import_react8.useCallback)(
    (error2) => {
      var _a2;
  ...
  const memoizedChildren = (0, import_react8.useMemo)(() => children, [children]);
...
var useTree = () => {
  const [tree, dispatch2] = (0, import_react9.useReducer)(treeReducer, []);
  const addElement = (0, import_react9.useCallback)(
  ...
  const removeElement = (0, import_react9.useCallback)((id) => {
    dispatch2({ type: "REMOVE_NODE", id });
  }, []);
  const getAllElements = (0, import_react9.useCallback)(() => {
    return tree;
  }, [tree]);
  const printTree = (0, import_react9.useCallback)(
    (categories) => {
...
// node_modules/@copilotkit/react-core/dist/chunk-YYN33GSG.mjs
var import_react10 = __toESM(require_react(), 1);
var useFlatCategoryStore = () => {
  const [elements, dispatch2] = (0, import_react10.useReducer)(
    flatCategoryStoreReducer,
    /* @__PURE__ */ new Map()
  );
  const addElement = (0, import_react10.useCallback)((value2, categories) => {
  ...
  const removeElement = (0, import_react10.useCallback)((id) => {
    dispatch2({ type: "REMOVE_ELEMENT", id });
  }, []);
  const allElements = (0, import_react10.useCallback)(
    (categories) => {
      const categoriesSet = new Set(categories);
      const result = [];
...
// node_modules/@copilotkit/react-core/dist/chunk-C3YJYDK4.mjs
var RenderStatus = ((RenderStatus2) => {
  RenderStatus2["InProgress"] = "inProgress";
  RenderStatus2["Complete"] = "complete";
  return RenderStatus2;
})(RenderStatus || {});
var ClaimAction = ((ClaimAction2) => {
...
function getStateWithoutConstantKeys(state) {
  if (!state)
    return {};
  const _a2 = state, { messages, tools, copilotkit } = _a2, stateWithoutConstantKeys = __objRest(_a2, ["messages", "tools", "copilotkit"]);
  return stateWithoutConstantKeys;
}
function areStatesEquals(a2, b) {
  if (a2 && !b || !a2 && b)
    return false;
  const _a2 = a2, { messages, tools, copilotkit } = _a2, aWithoutConstantKeys = __objRest(_a2, ["messages", "tools", "copilotkit"]);
  const _b2 = b, {
    messages: bMessages,
    tools: bTools,
    copilotkit: bCopilotkit
  } = _b2, bWithoutConstantKeys = __objRest(_b2, [
    "messages",
    "tools",
    "copilotkit"
  ]);
...
function resolveClaim({
  ...
  if (existing) {
    ...
    return {
      canRender,
      action: canRender ? "existing" : "block",
  ...
  const renderClaimedByOtherMessageEntry = Object.entries(claims).find(
    ([, claim]) => {
      var _a2;
      return claim.stateRenderId === stateRenderId && ((_a2 = claim.runId) != null ? _a2 : "pending") === normalizedRunId && dataToUUID(getStateWithoutConstantKeys(claim.stateSnapshot)) === dataToUUID(getStateWithoutConstantKeys(stateSnapshot));
    }
  );
...
function selectSnapshot({
  ...
  const lastAssistantId = agentMessages ? (_a2 = [...agentMessages].reverse().find((msg) => msg.role === "assistant")) == null ? void 0 : _a2.id : void 0;
  ...
  const messageRole = messageIndex >= 0 && agentMessages ? (_b2 = agentMessages[messageIndex]) == null ? void 0 : _b2.role : void 0;
  let previousUserMessageId;
  if (messageIndex > 0 && agentMessages) {
    for (let i3 = messageIndex - 1; i3 >= 0; i3 -= 1) {
      if (((_c = agentMessages[i3]) == null ? void 0 : _c.role) === "user") {
        previousUserMessageId = (_d = agentMessages[i3]) == null ? void 0 : _d.id;
        break;
      }
    }
  }
...
// node_modules/@copilotkit/react-core/dist/chunk-77IVITG3.mjs
...
function getSnapshotCaches(claimsRef) {
  ...
  return {
    byStateRenderAndRun: (_a2 = store[LAST_SNAPSHOTS_BY_RENDER_AND_RUN]) != null ? _a2 : {},
    byMessageId: (_b2 = store[LAST_SNAPSHOTS_BY_MESSAGE]) != null ? _b2 : {}
  };
}
function useStateRenderRegistry({
  ...
  const cachedMessageEntry = (_a2 = store[LAST_SNAPSHOTS_BY_MESSAGE]) == null ? void 0 : _a2[message2.id];
  const { runId: cachedMessageRunId } = readCachedMessageEntry(cachedMessageEntry);
  const existingClaimRunId = (_b2 = claimsRef.current[message2.id]) == null ? void 0 : _b2.runId;
  ...
  (0, import_react11.useEffect)(() => {
    return () => {
      ...
      const existingClaim2 = claimsRef.current[message2.id];
      if ((existingClaim2 == null ? void 0 : existingClaim2.stateSnapshot) && Object.keys(existingClaim2.stateSnapshot).length > 0) {
        const snapshotCache = __spreadValues({}, (_a22 = store[LAST_SNAPSHOTS_BY_RENDER_AND_RUN]) != null ? _a22 : {});
        const cacheKey = `${existingClaim2.stateRenderId}::${(_b22 = existingClaim2.runId) != null ? _b22 : "pending"}`;
      ...
      delete claimsRef.current[message2.id];
    };
  }, [claimsRef, effectiveRunId, message2.id]);
  if (!stateRenderId) {
    return { canRender: false };
  }
  const caches = getSnapshotCaches(claimsRef);
  const existingClaim = claimsRef.current[message2.id];
  const { snapshot, hasSnapshotKeys, allowEmptySnapshot, snapshotForClaim } = selectSnapshot({
    messageId: message2.id,
    messageName: message2.name,
    allowLiveState: isPlaceholderMessageName(message2.name) || isPlaceholderMessageId(message2.id),
    skipLatestCache: isPlaceholderMessageName(message2.name) || isPlaceholderMessageId(message2.id),
    stateRenderId,
    effectiveRunId,
  ...
  if (resolution.updateRunId && claimsRef.current[message2.id]) {
    claimsRef.current[message2.id].runId = resolution.updateRunId;
  }
  if (resolution.nextClaim) {
    claimsRef.current[message2.id] = resolution.nextClaim;
  }
  if (resolution.lockOthers) {
    Object.entries(claimsRef.current).forEach(([id, claim]) => {
      if (id !== message2.id && claim.stateRenderId === stateRenderId) {
        claim.locked = true;
      }
    });
  }
  if (existingClaim && !existingClaim.locked && (agentMessages == null ? void 0 : agentMessages.length)) {
    const indexInAgentMessages = agentMessages.findIndex((msg) => msg.id === message2.id);
    if (indexInAgentMessages >= 0 && indexInAgentMessages < agentMessages.length - 1) {
      existingClaim.locked = true;
    }
  }
  const existingSnapshot = claimsRef.current[message2.id].stateSnapshot;
  const snapshotChanged = stateSnapshot && existingSnapshot !== void 0 && !areStatesEquals(existingSnapshot, snapshot);
  if (snapshot && (stateSnapshot || hasSnapshotKeys || allowEmptySnapshot) && (!claimsRef.current[message2.id].locked || snapshotChanged)) {
    if (!claimsRef.current[message2.id].locked || snapshotChanged) {
      claimsRef.current[message2.id].stateSnapshot = snapshot;
      ...
      messageCache[message2.id] = { snapshot, runId: effectiveRunId };
      store[LAST_SNAPSHOTS_BY_MESSAGE] = messageCache;
      if (stateSnapshot) {
        claimsRef.current[message2.id].locked = true;
      }
    }
  } else if (snapshotForClaim) {
    const existingSnapshot2 = claimsRef.current[message2.id].stateSnapshot;
    if (!existingSnapshot2) {
      claimsRef.current[message2.id].stateSnapshot = snapshotForClaim;
      ...
      messageCache[message2.id] = { snapshot: snapshotForClaim, runId: effectiveRunId };
      store[LAST_SNAPSHOTS_BY_MESSAGE] = messageCache;
    }
  }
...
// node_modules/@copilotkit/react-core/dist/chunk-QD7EID4N.mjs
var import_react12 = __toESM(require_react(), 1);
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
var CoAgentStateRendersContext = (0, import_react12.createContext)(
  void 0
);
function CoAgentStateRendersProvider({ children }) {
  ...
  const claimsRef = (0, import_react12.useRef)({});
...
function useCoAgentStateRenders() {
  const context = (0, import_react12.useContext)(CoAgentStateRendersContext);
  if (!context) {
...
// node_modules/@copilotkit/react-core/dist/chunk-BKMJ4LC7.mjs
var import_react14 = __toESM(require_react(), 1);
function useCoagentStateRenderBridge(agentId, props) {
  var _a2;
  const { stateSnapshot, message: message2 } = props;
  const { coAgentStateRenders, claimsRef } = useCoAgentStateRenders();
  const { agent } = useAgent({ agentId });
  const [nodeName, setNodeName] = (0, import_react14.useState)(void 0);
  const [, forceUpdate] = (0, import_react14.useState)(0);
  (0, import_react14.useEffect)(() => {
    if (!agent)
      return;
    const subscriber = {
      onStateChanged: () => {
        forceUpdate((value2) => value2 + 1);
      },
  ...
  const stateRenderEntry = (0, import_react14.useMemo)(() => getStateRender(message2.id), [getStateRender, message2.id]);
  ...
  const registryMessage = __spreadProps(__spreadValues({}, message2), {
    runId: (_a2 = props.runId) != null ? _a2 : message2.runId
  });
  ...
  return (0, import_react14.useMemo)(() => {
    ...
    if (stateRender.handler) {
      stateRender.handler({
        state: stateSnapshot ? parseJson(stateSnapshot, stateSnapshot) : (_a22 = agent == null ? void 0 : agent.state) != null ? _a22 : {},
    ...
    if (stateRender.render) {
      ...
      return stateRender.render({
        ...
        state: (_b2 = claimsRef.current[message2.id].stateSnapshot) != null ? _b2 : {},
        nodeName: nodeName != null ? nodeName : ""
      });
    }
  }, [
...
// node_modules/@copilotkit/react-core/dist/chunk-LMHB2D4J.mjs
var import_react15 = __toESM(require_react(), 1);
var import_jsx_runtime8 = __toESM(require_jsx_runtime(), 1);
var ThreadsContext = (0, import_react15.createContext)(void 0);
function ThreadsProvider({ children, threadId: explicitThreadId }) {
  const [internalThreadId, setThreadId] = (0, import_react15.useState)(() => randomUUID2());
...
function useThreads() {
  const context = (0, import_react15.useContext)(ThreadsContext);
  if (!context) {
...
// node_modules/@copilotkit/react-core/dist/chunk-WF65O6HX.mjs
var import_react16 = __toESM(require_react(), 1);
var usePredictStateSubscription = (agent) => {
  const predictStateToolsRef = (0, import_react16.useRef)([]);
  const getSubscriber = (0, import_react16.useCallback)(
    (agent2) => ({
      onCustomEvent: ({ event }) => {
      ...
      onToolCallArgsEvent: ({ partialToolCallArgs, toolCallName }) => {
        predictStateToolsRef.current.forEach((t2) => {
          if ((t2 == null ? void 0 : t2.tool) !== toolCallName)
            return;
          ...
          agent2.setState({
            [t2.state_key]: emittedState[t2.state_key]
          });
        });
      }
    }),
  ...
  (0, import_react16.useEffect)(() => {
    const subscriber = {
      onError: ({ error: error2 }) => {
        setBannerError(new CopilotKitLowLevelError({ error: error2, message: error2.message }));
      }
    };
...
// node_modules/@copilotkit/react-core/dist/chunk-DQXCQWSG.mjs
...
function CopilotKit(_a2) {
  ...
  const renderArr = (0, import_react18.useMemo)(() => [{ render: CoAgentStateRenderBridge }], []);
  return (0, import_jsx_runtime9.jsx)(ToastProvider, { enabled, children: (0, import_jsx_runtime9.jsx)(CopilotErrorBoundary, { publicApiKey, showUsageBanner: enabled, children: (0, import_jsx_runtime9.jsx)(ThreadsProvider, { threadId: props.threadId, children: (0, import_jsx_runtime9.jsx)(
    CopilotKitProvider,
    __spreadProps(__spreadValues({}, props), {
      showDevConsole: showInspector,
      renderCustomMessages: renderArr,
      useSingleEndpoint: true,
      children: (0, import_jsx_runtime9.jsx)(CopilotKitInternal, __spreadProps(__spreadValues({}, props), { children }))
    })
  ) }) }) });
}
...
function CopilotKitInternal(cpkProps) {
  ...
  const [registeredActionConfigs, setRegisteredActionConfigs] = (0, import_react18.useState)(/* @__PURE__ */ new Map());
  const chatComponentsCache = (0, import_react18.useRef)({
    actions: {},
    coAgentStateRenders: {}
  });
  ...
  const [chatInstructions, setChatInstructions] = (0, import_react18.useState)("");
  const [authStates, setAuthStates] = (0, import_react18.useState)({});
  const [extensions, setExtensions] = (0, import_react18.useState)({});
  const [additionalInstructions, setAdditionalInstructions] = (0, import_react18.useState)([]);
  const {
    addElement: addDocument,
    removeElement: removeDocument,
    allElements: allDocuments
  } = use_flat_category_store_default();
  const setAction = (0, import_react18.useCallback)((id, action) => {
  ...
  const removeAction = (0, import_react18.useCallback)((id) => {
    setActions((prevPoints) => {
      const newPoints = __spreadValues({}, prevPoints);
      delete newPoints[id];
      return newPoints;
  ...
  const getContextString = (0, import_react18.useCallback)(
    (documents2, categories) => {
      const documentsString = documents2.map((document3) => {
        return `${document3.name} (${document3.sourceApplication}):
${document3.getContents()}`;
      }).join("\n\n");
...
${nonDocumentStrings}`;
  ...
  const addContext = (0, import_react18.useCallback)(
    (context, parentId, categories = defaultCopilotContextCategories) => {
      return addElement(context, categories, parentId);
    },
    [addElement]
  );
  const removeContext = (0, import_react18.useCallback)(
    (id) => {
      removeElement(id);
    },
    [removeElement]
  );
  const getAllContext = (0, import_react18.useCallback)(() => {
    return getAllElements();
  }, [getAllElements]);
  const getFunctionCallHandler = (0, import_react18.useCallback)(
    (customEntryPoints) => {
      return entryPointsToFunctionCallHandler(Object.values(customEntryPoints || actions));
    },
    [actions]
  );
  const getDocumentsContext = (0, import_react18.useCallback)(
    (categories) => {
      return allDocuments(categories);
    },
    [allDocuments]
  );
  const addDocumentContext = (0, import_react18.useCallback)(
    (documentPointer, categories = defaultCopilotContextCategories) => {
      return addDocument(documentPointer, categories);
    },
    [addDocument]
  );
  const removeDocumentContext = (0, import_react18.useCallback)(
    (documentId) => {
      removeDocument(documentId);
    },
    [removeDocument]
  );
  const copilotApiConfig = (0, import_react18.useMemo)(() => {
    var _a22, _b22;
    let cloud = void 0;
    if (publicApiKey) {
      cloud = {
  ...
  const [internalErrorHandlers, _setInternalErrorHandler] = (0, import_react18.useState)({});
  const setInternalErrorHandler = (0, import_react18.useCallback)((handler) => {
    _setInternalErrorHandler((prev) => __spreadValues(__spreadValues({}, prev), handler));
  }, []);
  const removeInternalErrorHandler = (0, import_react18.useCallback)((key) => {
    _setInternalErrorHandler((prev) => {
      const _a22 = prev, { [key]: _removed } = _a22, rest = __objRest(_a22, [__restKey(key)]);
      return rest;
    });
  }, []);
  const onErrorRef = (0, import_react18.useRef)(props.onError);
  (0, import_react18.useEffect)(() => {
    onErrorRef.current = props.onError;
  }, [props.onError]);
  const internalHandlersRef = (0, import_react18.useRef)({});
  (0, import_react18.useEffect)(() => {
    internalHandlersRef.current = internalErrorHandlers;
  }, [internalErrorHandlers]);
  const handleErrors = (0, import_react18.useCallback)(
  ...
  const [chatSuggestionConfiguration, setChatSuggestionConfiguration] = (0, import_react18.useState)({});
  const addChatSuggestionConfiguration = (0, import_react18.useCallback)(
    (id, suggestion) => {
      setChatSuggestionConfiguration((prev) => __spreadProps(__spreadValues({}, prev), { [id]: suggestion }));
    },
    [setChatSuggestionConfiguration]
  );
  const removeChatSuggestionConfiguration = (0, import_react18.useCallback)(
    (id) => {
  ...
  const [availableAgents, setAvailableAgents] = (0, import_react18.useState)([]);
  const [coagentStates, setCoagentStates] = (0, import_react18.useState)({});
  const coagentStatesRef = (0, import_react18.useRef)({});
  const setCoagentStatesWithRef = (0, import_react18.useCallback)(
    (value2) => {
  ...
  const [agentSession, setAgentSession] = (0, import_react18.useState)(initialAgentSession);
  (0, import_react18.useEffect)(() => {
    if (props.agent) {
      setAgentSession({
        agentName: props.agent
  ...
  const setThreadId = (0, import_react18.useCallback)(
    (value2) => {
      if (props.threadId) {
  ...
  const chatAbortControllerRef = (0, import_react18.useRef)(null);
  const showDevConsole = shouldShowDevConsole(props.showDevConsole);
  const [interruptActions, _setInterruptActions] = (0, import_react18.useState)({});
  const setInterruptAction = (0, import_react18.useCallback)((action) => {
    _setInterruptActions((prev) => {
      ...
      return __spreadProps(__spreadValues({}, prev), {
        [action.id]: __spreadValues(__spreadValues({}, (_a22 = prev[action.id]) != null ? _a22 : {}), action)
      });
    });
  }, []);
  const removeInterruptAction = (0, import_react18.useCallback)((actionId) => {
    _setInterruptActions((prev) => {
      const _a22 = prev, { [actionId]: _ } = _a22, rest = __objRest(_a22, [__restKey(actionId)]);
      return rest;
    });
  }, []);
  const [interruptEventQueue, setInterruptEventQueue] = (0, import_react18.useState)({});
  const addInterruptEvent = (0, import_react18.useCallback)((queuedEvent) => {
  ...
  const resolveInterruptEvent = (0, import_react18.useCallback)(
  ...
  const memoizedChildren = (0, import_react18.useMemo)(() => children, [children]);
  const [bannerError, setBannerError] = (0, import_react18.useState)(null);
  const agentLock = (0, import_react18.useMemo)(() => {
    var _a22;
    return (_a22 = props.agent) != null ? _a22 : null;
  }, [props.agent]);
  const forwardedParameters = (0, import_react18.useMemo)(
    () => {
      var _a22;
  ...
  const updateExtensions = (0, import_react18.useCallback)(
    (newExtensions) => {
      setExtensions((prev) => {
  ...
  const updateAuthStates = (0, import_react18.useCallback)(
    (newAuthStates) => {
      setAuthStates((prev) => {
  ...
  const handleSetRegisteredActions = (0, import_react18.useCallback)((actionConfig) => {
    const key = actionConfig.action.name || randomUUID2();
  ...
  const handleRemoveRegisteredAction = (0, import_react18.useCallback)((actionKey) => {
    setRegisteredActionConfigs((prev) => {
      const newMap = new Map(prev);
  ...
  const RegisteredActionsRenderer = (0, import_react18.useMemo)(() => {
    return () => (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: Array.from(registeredActionConfigs.entries()).map(([key, config]) => {
      const Component = config.component;
      return (0, import_jsx_runtime9.jsx)(Component, { action: config.action }, key);
    }) });
  }, [registeredActionConfigs]);
  return (0, import_jsx_runtime9.jsx)(
    CopilotChatConfigurationProvider,
    {
      agentId: (_b2 = props.agent) != null ? _b2 : "default",
      threadId,
      children: (0, import_jsx_runtime9.jsxs)(
        CopilotContext.Provider,
        {
          ...
          children: [
            (0, import_jsx_runtime9.jsx)(CopilotListeners, {}),
            (0, import_jsx_runtime9.jsx)(CopilotKitErrorBridge, {}),
            (0, import_jsx_runtime9.jsxs)(CoAgentStateRendersProvider, { children: [
              (0, import_jsx_runtime9.jsx)(MessagesTapProvider, { children: (0, import_jsx_runtime9.jsxs)(CopilotMessages, { children: [
                memoizedChildren,
                (0, import_jsx_runtime9.jsx)(RegisteredActionsRenderer, {})
              ] }) }),
              bannerError && showDevConsole && (0, import_jsx_runtime9.jsx)(
                UsageBanner,
                {
...
// node_modules/@copilotkit/react-core/dist/chunk-VP43SLSZ.mjs
...
// node_modules/@copilotkit/react-core/dist/chunk-4RRMC7L2.mjs
var import_react20 = __toESM(require_react(), 1);
function useLangGraphInterrupt(action, dependencies) {
  const { setInterruptAction, removeInterruptAction, interruptActions, threadId } = (0, import_react20.useContext)(CopilotContext);
  const { addToast } = useToast();
...
// node_modules/@copilotkit/react-core/dist/chunk-7IBF6RBW.mjs
var import_react21 = __toESM(require_react(), 1);
function useMakeCopilotDocumentReadable(document3, categories, dependencies = []) {
  const { addDocumentContext, removeDocumentContext } = useCopilotContext();
  const idRef = (0, import_react21.useRef)(void 0);
  (0, import_react21.useEffect)(() => {
    const id = addDocumentContext(document3, categories);
    idRef.current = id;
    return () => {
...
// node_modules/@copilotkit/react-core/dist/chunk-Z6JV2LRY.mjs
var import_react23 = __toESM(require_react(), 1);
function useCopilotReadable({ description, value: value2, convert: convert2, available }, dependencies) {
  const { copilotkit } = useCopilotKit();
  const ctxIdRef = (0, import_react23.useRef)(void 0);
  (0, import_react23.useEffect)(() => {
    if (!copilotkit)
      return;
    const found = Object.entries(copilotkit.context).find(([id, ctxItem]) => {
      return JSON.stringify({ description, value: value2 }) == JSON.stringify(ctxItem);
    });
    if (found) {
    ...
    ctxIdRef.current = copilotkit.addContext({
      description,
      value: (convert2 != null ? convert2 : JSON.stringify)(value2)
    });
    return () => {
      if (!ctxIdRef.current)
        return;
...
var useCopilotRuntimeClient = (options) => {
  ...
  const lastStructuredErrorRef = (0, import_react24.useRef)(null);
  ...
  const runtimeClient = (0, import_react24.useMemo)(() => {
...
// node_modules/@copilotkit/react-core/dist/chunk-NBK4KBLX.mjs
var import_react25 = __toESM(require_react(), 1);
function useRenderToolCall2(tool, dependencies) {
  const { copilotkit } = useCopilotKit();
  const hasAddedRef = (0, import_react25.useRef)(false);
  (0, import_react25.useEffect)(() => {
    const { name: name2, parameters, render } = tool;
    const zodParameters = getZodParameters(parameters);
    const renderToolCall = name2 === "*" ? defineToolCallRenderer({
      name: "*",
      render: (args) => {
    ...
    const existingIndex = copilotkit.renderToolCalls.findIndex((r2) => r2.name === name2);
    if (existingIndex !== -1) {
    ...
    return () => {
      if (hasAddedRef.current) {
        const index3 = copilotkit.renderToolCalls.findIndex((r2) => r2.name === name2);
        if (index3 !== -1) {
          copilotkit.renderToolCalls.splice(index3, 1);
        }
...
// node_modules/@copilotkit/react-core/dist/chunk-VGL3DGUW.mjs
var import_react27 = __toESM(require_react(), 1);
function useFrontendTool2(tool, dependencies) {
  const { name: name2, description, parameters, render, followUp } = tool;
  const zodParameters = getZodParameters(parameters);
...
// node_modules/@copilotkit/react-core/dist/chunk-7DTB7S5V.mjs
var import_react30 = __toESM(require_react(), 1);
function useHumanInTheLoop2(tool, dependencies) {
  const _a2 = tool, { render } = _a2, toolRest = __objRest(_a2, ["render"]);
  const { name: name2, description, parameters, followUp } = toolRest;
  const zodParameters = getZodParameters(parameters);
  const renderRef = (0, import_react30.useRef)(null);
  (0, import_react30.useEffect)(() => {
    renderRef.current = (args) => {
      if (typeof render === "string") {
        return import_react30.default.createElement(import_react30.default.Fragment, null, render);
      }
      if (!render) {
        return null;
      }
  ...
  useHumanInTheLoop({
    ...
    render: (args) => {
      var _a22, _b2;
      return (_b2 = (_a22 = renderRef.current) == null ? void 0 : _a22.call(renderRef, args)) != null ? _b2 : null;
    }
  });
}

// node_modules/@copilotkit/react-core/dist/chunk-RBGVEVWY.mjs
...
function useCopilotAction(action, dependencies) {
  const [initialActionConfig] = (0, import_react31.useState)(getActionConfig(action));
  ...
  switch (currentActionConfig.type) {
    ...
    case "hitl":
      return useHumanInTheLoop2(currentActionConfig.action, dependencies);
    case "frontend":
      return useFrontendTool2(currentActionConfig.action, dependencies);
    default:
      throw new Error("Invalid action configuration");
  }
}

// node_modules/@copilotkit/react-core/dist/chunk-7JTI6ZL4.mjs
function useDefaultTool(tool, dependencies) {
  useCopilotAction(__spreadProps(__spreadValues({}, tool), { name: "*" }), dependencies);
}

// node_modules/@copilotkit/react-core/dist/chunk-I76HKHPJ.mjs
var import_react32 = __toESM(require_react(), 1);
function useAgentNodeName(agentName) {
  const { agent } = useAgent({ agentId: agentName });
  const nodeNameRef = (0, import_react32.useRef)("start");
...
// node_modules/@copilotkit/react-core/dist/chunk-ZYTXB6HH.mjs
var import_react34 = __toESM(require_react(), 1);
function useCoAgent(options) {
  const { agent } = useAgent({ agentId: options.name });
  const { copilotkit } = useCopilotKit();
  const nodeName = useAgentNodeName(options.name);
  const handleStateUpdate = (0, import_react34.useCallback)(
    (newState) => {
      if (!agent)
        return;
  ...
  (0, import_react34.useEffect)(() => {
    ...
    if (!options.config && !options.configurable)
      return;
    let config = (_a2 = options.config) != null ? _a2 : {};
  ...
  const externalStateStr = (0, import_react34.useMemo)(
  ...
  const hasStateValues = (0, import_react34.useCallback)((value2) => {
    return Boolean(value2 && Object.keys(value2).length);
  }, []);
  const initialStateRef = (0, import_react34.useRef)(
  ...
  return (0, import_react34.useMemo)(() => {
    ...
    if (!agent) {
      ...
      const initialState = (
        ...
        (_b2 = (_a2 = "state" in options && options.state) != null ? _a2 : (
...
// node_modules/@copilotkit/react-core/dist/chunk-ABWT4DRT.mjs
...
// node_modules/@copilotkit/react-core/dist/chunk-SRJT5VVY.mjs
var import_react37 = __toESM(require_react(), 1);
var import_react38 = __toESM(require_react(), 1);
function useCopilotAuthenticatedAction_c(action, dependencies) {
  const { authConfig_c, authStates_c, setAuthStates_c } = useCopilotContext();
  const pendingActionRef = (0, import_react37.useRef)(null);
  const executeAction = (0, import_react37.useCallback)(
    (props) => {
      if (typeof action.render === "function") {
        return action.render(props);
      }
      return action.render || import_react38.default.createElement(import_react37.Fragment);
    },
    [action]
  );
  const wrappedRender = (0, import_react37.useCallback)(
    (props) => {
      ...
      if (!isAuthenticated) {
        ...
        return (authConfig_c == null ? void 0 : authConfig_c.SignInComponent) ? import_react38.default.createElement(authConfig_c.SignInComponent, {
        ...
        }) : import_react38.default.createElement(import_react37.Fragment);
      }
...
// node_modules/@copilotkit/react-core/dist/chunk-ZVF5Q6IH.mjs
...
function useLazyToolRenderer() {
  ...
  return (0, import_react40.useCallback)(
    (message2, messages) => {
      var _a2;
      if (!((_a2 = message2 == null ? void 0 : message2.toolCalls) == null ? void 0 : _a2.length))
        return null;
      const toolCall = message2.toolCalls[0];
      if (!toolCall)
        return null;
...
// node_modules/@copilotkit/react-core/dist/chunk-VV56AVPB.mjs
...
function useLangGraphInterruptRender(agent) {
  ...
  const existingConfig = useCopilotChatConfiguration();
  const resolvedAgentId = (_a2 = existingConfig == null ? void 0 : existingConfig.agentId) != null ? _a2 : "default";
  ...
  const handleResolve = (0, import_react41.useCallback)(
    (eventId, response) => {
      agent == null ? void 0 : agent.runAgent({
        forwardedProps: {
          command: {
  ...
  return (0, import_react41.useMemo)(() => {
    ...
    if (!render)
      return null;
    return import_react41.default.createElement(InterruptRenderer, {
      event: currentQueuedEvent.event,
      result,
      render,
      resolve: resolveInterrupt
...
// node_modules/@copilotkit/react-core/dist/chunk-LO4RRITI.mjs
...
var ensureBinaryPayload = (value2, ctx) => {
  if (!value2.id && !value2.url && !value2.data) {
    ctx.addIssue({
...
var BinaryInputContentSchema = BinaryInputContentObjectSchema.superRefine((value2, ctx) => {
  ensureBinaryPayload(value2, ctx);
});
var InputContentBaseSchema = external_exports.discriminatedUnion("type", [
  TextInputContentSchema,
  BinaryInputContentObjectSchema
]);
var InputContentSchema = InputContentBaseSchema.superRefine((value2, ctx) => {
...
var Wt = external_exports.object({ type: external_exports.literal(C2.enum.TextMessageStart), messageId: external_exports.string(), parentMessageId: external_exports.string().optional(), role: external_exports.string().optional() });
var Yt = external_exports.object({ type: external_exports.literal(C2.enum.TextMessageContent), messageId: external_exports.string(), content: external_exports.string() });
var qt = external_exports.object({ type: external_exports.literal(C2.enum.TextMessageEnd), messageId: external_exports.string() });
var Qt = external_exports.object({ type: external_exports.literal(C2.enum.ActionExecutionStart), actionExecutionId: external_exports.string(), actionName: external_exports.string(), parentMessageId: external_exports.string().optional() });
var Zt = external_exports.object({ type: external_exports.literal(C2.enum.ActionExecutionArgs), actionExecutionId: external_exports.string(), args: external_exports.string() });
var te = external_exports.object({ type: external_exports.literal(C2.enum.ActionExecutionEnd), actionExecutionId: external_exports.string() });
var ee = external_exports.object({ type: external_exports.literal(C2.enum.ActionExecutionResult), actionName: external_exports.string(), actionExecutionId: external_exports.string(), result: external_exports.string() });
var ne = external_exports.object({ type: external_exports.literal(C2.enum.AgentStateMessage), threadId: external_exports.string(), agentName: external_exports.string(), nodeName: external_exports.string(), runId: external_exports.string(), active: external_exports.boolean(), role: external_exports.string(), state: external_exports.string(), running: external_exports.boolean() });
var se = external_exports.object({ type: external_exports.literal(C2.enum.MetaEvent), name: Vt, value: external_exports.any() });
var ae = external_exports.object({ type: external_exports.literal(C2.enum.RunError), message: external_exports.string(), code: external_exports.string().optional() });
...
function useCopilotChatInternal({
  ...
  const existingConfig = useCopilotChatConfiguration();
  const [agentAvailable, setAgentAvailable] = (0, import_react43.useState)(false);
  const resolvedAgentId = (_a2 = existingConfig == null ? void 0 : existingConfig.agentId) != null ? _a2 : "default";
  const { agent } = useAgent({ agentId: resolvedAgentId });
  (0, import_react43.useEffect)(() => {
    const connect = (agent2) => __async(this, null, function* () {
      ...
      try {
        ...
        if (error2 instanceof AGUIConnectNotImplementedError) {
        } else {
          console.error("CopilotChat: connectAgent failed", error2);
        }
      }
    });
  ...
  const deleteMessage = (0, import_react43.useCallback)(
    (messageId) => {
      var _a22;
      const filteredMessages = ((_a22 = agent == null ? void 0 : agent.messages) != null ? _a22 : []).filter(
        (message2) => message2.id !== messageId
      );
  ...
  const latestDeleteFunc = (0, import_react43.useCallback)(
    (messageId) => {
  ...
  const reload = useAsyncCallback(
    (reloadMessageId) => __async(this, null, function* () {
      var _a22;
      const messages = (_a22 = agent == null ? void 0 : agent.messages) != null ? _a22 : [];
      ...
      if (agent) {
        try {
          ...
          console.error("CopilotChat: runAgent failed during reload", error2);
        }
      }
      return;
    }),
  ...
  const latestSendMessageFunc = useAsyncCallback(
    (message2, options) => __async(this, null, function* () {
      var _a22;
      if (!agent)
        return;
      const followUp = (_a22 = options == null ? void 0 : options.followUp) != null ? _a22 : true;
      if (options == null ? void 0 : options.clearSuggestions) {
        copilotkit.clearSuggestions(resolvedAgentId);
      }
      if (onSubmitMessage) {
        const content3 = typeof message2.content === "string" ? message2.content : message2.content && "text" in message2.content ? message2.content.text : message2.content && "filename" in message2.content ? message2.content.filename : "";
        try {
          yield onSubmitMessage(content3);
        } catch (error2) {
          console.error("Error in onSubmitMessage:", error2);
        }
      }
      agent == null ? void 0 : agent.addMessage(message2);
      if (followUp) {
        try {
          yield copilotkit.runAgent({ agent });
        } catch (error2) {
          console.error("CopilotChat: runAgent failed", error2);
        }
      }
    }),
  ...
  const latestAppendFunc = useAsyncCallback(
    (message2, options) => __async(this, null, function* () {
      return latestSendMessageFunc(gqlToAGUI([message2])[0], options);
    }),
    [latestSendMessageFunc]
  );
  const latestSetMessagesFunc = (0, import_react43.useCallback)(
    (messages) => {
      var _a22, _b22;
      if (messages.every((message2) => message2 instanceof Message)) {
        return (_a22 = agent == null ? void 0 : agent.setMessages) == null ? void 0 : _a22.call(agent, gqlToAGUI(messages));
      }
      return (_b22 = agent == null ? void 0 : agent.setMessages) == null ? void 0 : _b22.call(agent, messages);
    },
  ...
  const latestReloadFunc = useAsyncCallback(
    (messageId) => __async(this, null, function* () {
      ...
      onReloadMessages == null ? void 0 : onReloadMessages({
        ...
        messages: (_a22 = agent == null ? void 0 : agent.messages) != null ? _a22 : []
      });
      return yield latestReload.current(messageId);
    }),
    [latestReload, agent, onReloadMessages]
  );
  const latestStopFunc = (0, import_react43.useCallback)(() => {
    var _a22, _b22;
    onStopGeneration == null ? void 0 : onStopGeneration({
      currentAgentName: agent == null ? void 0 : agent.agentId,
      messages: (_a22 = agent == null ? void 0 : agent.messages) != null ? _a22 : []
    });
    return (_b22 = agent == null ? void 0 : agent.abortRun) == null ? void 0 : _b22.call(agent);
  }, [onStopGeneration, agent]);
  const latestReset = useUpdatedRef(reset);
  const latestResetFunc = (0, import_react43.useCallback)(() => {
  ...
  const legacyCustomMessageRenderer = useLegacyCoagentRenderer({
    ...
    threadId: (_b2 = existingConfig == null ? void 0 : existingConfig.threadId) != null ? _b2 : threadId
  });
  const allMessages = (_c = agent == null ? void 0 : agent.messages) != null ? _c : [];
  const resolvedMessages = (0, import_react43.useMemo)(() => {
    var _a22, _b22;
    let processedMessages = allMessages.map((message2) => {
      if (message2.role !== "assistant") {
        return message2;
      }
      const lazyRendered = lazyToolRendered(message2, allMessages);
      if (lazyRendered) {
        const renderedGenUi = lazyRendered();
        if (renderedGenUi) {
          return __spreadProps(__spreadValues({}, message2), { generativeUI: () => renderedGenUi });
        }
      }
      const bridgeRenderer = legacyCustomMessageRenderer || renderCustomMessage ? () => {
        var _a3;
        if (legacyCustomMessageRenderer) {
          return legacyCustomMessageRenderer({ message: message2, position: "before" });
        }
        try {
          return (_a3 = renderCustomMessage == null ? void 0 : renderCustomMessage({ message: message2, position: "before" })) != null ? _a3 : null;
        } catch (error2) {
          console.warn(
      ...
      if (bridgeRenderer) {
        return __spreadProps(__spreadValues({}, message2), {
    ...
    const canUseCustomRenderer = Boolean(
      renderCustomMessage && ((_a22 = copilotkit == null ? void 0 : copilotkit.getAgent) == null ? void 0 : _a22.call(copilotkit, resolvedAgentId))
    );
    ...
    const effectiveThreadId = (_b22 = threadId != null ? threadId : agent == null ? void 0 : agent.threadId) != null ? _b22 : "default";
    let latestUserIndex = -1;
    for (let i3 = processedMessages.length - 1; i3 >= 0; i3 -= 1) {
      if (processedMessages[i3].role === "user") {
        latestUserIndex = i3;
        break;
      }
    }
  ...
  const renderedSuggestions = (0, import_react43.useMemo)(() => {
...
function useUpdatedRef(value2) {
  const ref = (0, import_react43.useRef)(value2);
  (0, import_react43.useEffect)(() => {
    ref.current = value2;
  }, [value2]);
  return ref;
...
function useLegacyCoagentRenderer({
  ...
  return (0, import_react43.useMemo)(() => {
    ...
    return ({ message: message2, position: position4 }) => {
      var _a2;
      const effectiveThreadId = (_a2 = threadId != null ? threadId : agent.threadId) != null ? _a2 : "default";
      const providedRunId = message2.runId;
      const existingRunId = providedRunId ? providedRunId : copilotkit.getRunIdForMessage(agentId, effectiveThreadId, message2.id);
      const runId = existingRunId || `pending:${message2.id}`;
      const messageIndex = Math.max(
        agent.messages.findIndex((msg) => msg.id === message2.id),
        0
      );
      const bridgeProps = {
        message: message2,
        ...
        agentId,
        stateSnapshot: message2.state
      };
      return (0, import_react43.createElement)(CoAgentStateRenderBridge, bridgeProps);
    };
  }, [agent, agentId, copilotkit, threadId]);
}

// node_modules/@copilotkit/react-core/dist/chunk-XZFIJ7XF.mjs
...
// node_modules/@copilotkit/react-core/dist/chunk-XDFVCQD3.mjs
function useCopilotChatSuggestions(config, dependencies = []) {
  var _a2, _b2;
  const existingConfig = useCopilotChatConfiguration();
  const resolvedAgentId = (_a2 = existingConfig == null ? void 0 : existingConfig.agentId) != null ? _a2 : "default";
  const available = (_b2 = config.available === "enabled" ? "always" : config.available) != null ? _b2 : "before-first-message";
...
// node_modules/@copilotkit/react-core/dist/chunk-NXHQDCZF.mjs
...
// node_modules/@copilotkit/react-core/dist/chunk-VKNLTZJE.mjs
var import_react47 = __toESM(require_react(), 1);
function useCoAgentStateRender(action, dependencies) {
  const { chatComponentsCache, availableAgents } = (0, import_react47.useContext)(CopilotContext);
  const { setCoAgentStateRender, removeCoAgentStateRender, coAgentStateRenders } = useCoAgentStateRenders();
  const idRef = (0, import_react47.useRef)(randomId());
...
export {
  ...
  useRenderToolCall2 as useRenderToolCall,
  useFrontendTool2 as useFrontendTool,
  useHumanInTheLoop2 as useHumanInTheLoop,
  useCopilotAction,
  useDefaultTool,
  useCoAgent,
...
is-buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HDAA7IUQ.js.map
