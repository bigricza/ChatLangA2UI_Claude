...
var _a;
var WebInspectorElement = (_a = class extends LitElement {
  constructor() {
    super(...arguments);
    this._core = null;
    ...
    this.handlePointerDown = (event) => {
      ...
      const contextAttr = target == null ? void 0 : target.dataset.dragContext;
      const context = contextAttr === "window" ? "window" : "button";
      const eventTarget = event.target;
      if (context === "window" && (eventTarget == null ? void 0 : eventTarget.closest("button"))) {
        return;
      }
      ...
      this.draggedDuringInteraction = false;
      this.ignoreNextButtonClick = false;
      (_a2 = target == null ? void 0 : target.setPointerCapture) == null ? void 0 : _a2.call(target, this.pointerId);
    };
    ...
    this.handlePointerUp = (event) => {
      ...
      const target = event.currentTarget;
      if (target == null ? void 0 : target.hasPointerCapture(this.pointerId)) {
    ...
    this.handleResizePointerDown = (event) => {
      ...
      const target = event.currentTarget;
      (_a2 = target == null ? void 0 : target.setPointerCapture) == null ? void 0 : _a2.call(target, event.pointerId);
    };
    ...
    this.handleResizePointerUp = (event) => {
      ...
      const target = event.currentTarget;
      if (target == null ? void 0 : target.hasPointerCapture(this.resizePointerId)) {
    ...
    this.handleGlobalPointerDown = (event) => {
      ...
      const clickedDropdown = event.composedPath().some((node) => {
        var _a2;
        return node instanceof HTMLElement && ((_a2 = node.dataset) == null ? void 0 : _a2.contextDropdownRoot) === "true";
      });
      if (!clickedDropdown) {
        this.contextMenuOpen = false;
        this.requestUpdate();
  ...
  processAgentsChanged(agents) {
    ...
    for (const agent of Object.values(agents)) {
      if (!(agent == null ? void 0 : agent.agentId)) {
        continue;
      }
  ...
  tryAutoAttachCore() {
    ...
    const globalCandidates = [
      ...
      (_a2 = globalWindow.copilotkit) == null ? void 0 : _a2.core,
  ...
  updateContextOptions(agentIds) {
    ...
    const optionsChanged = this.contextOptions.length !== nextOptions.length || this.contextOptions.some((option, index) => {
      var _a2;
      return option.key !== ((_a2 = nextOptions[index]) == null ? void 0 : _a2.key);
    });
    if (optionsChanged) {
  ...
  getAgentStats(agentId) {
    ...
    const toolCallCount = messages ? messages.reduce((count, message) => {
      var _a3;
      return count + (((_a3 = message.toolCalls) == null ? void 0 : _a3.length) ?? 0);
    }, 0) : events.filter((e) => e.type === "TOOL_CALL_END").length;
    const messageCount = (messages == null ? void 0 : messages.length) ?? 0;
    return {
      totalEvents: events.length,
      lastActivity: ((_a2 = events[0]) == null ? void 0 : _a2.timestamp) ?? null,
  ...
  renderToolCallDetails(toolCalls) {
    ...
    return html`
      ...
      var _a2, _b;
      const functionName = ((_a2 = call.function) == null ? void 0 : _a2.name) ?? call.toolName ?? "Unknown function";
      const callId = typeof (call == null ? void 0 : call.id) === "string" ? call.id : `tool-call-${index + 1}`;
      const argsString = this.formatToolCallArguments((_b = call.function) == null ? void 0 : _b.arguments);
      return html`
  ...
  measureContext(context) {
    ...
    const element = (_a2 = this.renderRoot) == null ? void 0 : _a2.querySelector(selector);
    if (!element) {
      return;
    }
  ...
  renderIcon(name) {
    const iconNode = iconsAndAliases_exports[name];
    if (!iconNode) {
      return nothing;
    }
    const svgAttrs = {
  ...
  normalizeToolCalls(raw) {
    ...
    return raw.map((entry) => {
      ...
      const functionName = typeof (fn == null ? void 0 : fn.name) === "string" ? fn.name : typeof call.toolName === "string" ? call.toolName : void 0;
  ...
  getCoreStatusSummary() {
    ...
    const lastErrorMessage = (_a2 = this.lastCoreError) == null ? void 0 : _a2.message;
  ...
  handleEventFilterInput(event) {
    ...
    this.eventFilterText = (target == null ? void 0 : target.value) ?? "";
    this.requestUpdate();
  }
  ...
  renderContextDropdown() {
    ...
    const selectedLabel = ((_a2 = filteredOptions.find((opt) => opt.key === this.selectedContext)) == null ? void 0 : _a2.label) ?? "";
    return html`
        ...
        for (const [toolName, handler] of Object.entries(handlers)) {
          if (handler && typeof handler === "object") {
            ...
            tools.push({
              agentId,
              name: toolName,
              description: typeof handlerObj.description === "string" && handlerObj.description || ((_a2 = handlerObj.tool) == null ? void 0 : _a2.description),
              parameters: handlerObj.parameters ?? ((_b = handlerObj.tool) == null ? void 0 : _b.parameters),
              type: "handler"
            });
          }
        }
          ...
          if (!tools.some((t) => t.agentId === agentId && t.name === toolName)) {
            if (renderer && typeof renderer === "object") {
              ...
              tools.push({
                agentId,
                name: toolName,
                description: typeof rendererObj.description === "string" && rendererObj.description || ((_c = rendererObj.tool) == null ? void 0 : _c.description),
                parameters: rendererObj.parameters ?? ((_d = rendererObj.tool) == null ? void 0 : _d.parameters),
                type: "renderer"
              });
            }
          }
      ...
      if (zodDef.typeName === "ZodObject") {
        ...
        if (zodDef.unknownKeys === "strict" || !zodDef.catchall) {
          Object.keys(shape || {}).forEach((key) => {
            ...
            const fieldDef = candidate == null ? void 0 : candidate._def;
  ...
  isZodOptional(zodSchema) {
    ...
    if (!(schema == null ? void 0 : schema._def)) return false;
  ...
  extractZodFieldInfo(zodSchema) {
    const info = {};
    const schema = zodSchema;
    if (!(schema == null ? void 0 : schema._def)) return info;
    ...
    while (def2.typeName === "ZodOptional" || def2.typeName === "ZodNullable" || def2.typeName === "ZodDefault") {
      ...
      if (!(currentSchema == null ? void 0 : currentSchema._def)) break;
  ...
  renderContextCard(id, context) {
    ...
    const title = ((_a2 = context.description) == null ? void 0 : _a2.trim()) || id;
    return html`
      <div class="rounded-lg border border-gray-200 bg-white overflow-hidden">
        <button
          type="button"
  ...
  async fetchAnnouncement() {
    try {
      ...
      const timestamp = typeof (data == null ? void 0 : data.timestamp) === "string" ? data.timestamp : null;
      const previewText = typeof (data == null ? void 0 : data.previewText) === "string" ? data.previewText : null;
      const markdown = typeof (data == null ? void 0 : data.announcement) === "string" ? data.announcement : null;
...
lucide/dist/esm/lucide.js:
   ...
   *)
*/
//# sourceMappingURL=dist-DHETOJPL.js.map
