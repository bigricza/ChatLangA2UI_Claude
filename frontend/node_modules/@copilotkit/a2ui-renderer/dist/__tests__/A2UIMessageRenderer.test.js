...
describe("A2UIMessageRenderer uses correct processor type", () => {
    beforeEach(() => {
        ...
        v0_8.Data.A2uiMessageProcessor = class extends OriginalStandard {
            constructor() {
                super();
    ...
    afterEach(() => {
        ...
        v0_8.Data.A2uiMessageProcessor = OriginalStandard;
    });
    it("REGRESSION: A2UIMessageRenderer must use signal-based processor (not standard) for reactive data updates", async () => {
        ...
        const TestWrapper = () => {
            ...
            return _jsx(RenderComponent, { content: content, agent: null });
        };
...
describe("A2UIMessageRenderer rendering integration", () => {
    it("should render the themed-a2ui-surface custom element with surface data", async () => {
        ...
        const RenderComponent = renderer.render;
        const TestWrapper = () => _jsx(RenderComponent, { content: content, agent: null });
        let container;
        await act(async () => {
            const result = render(_jsx(TestWrapper, {}));
    ...
    it("should update surface when operations change", async () => {
        ...
        const updatedSurfaceElement = container.querySelector("themed-a2ui-surface");
    ...
    it("should handle multiple surfaces", () => {
        ...
        const messages = [
            ...
            { beginRendering: { surfaceId: "surface-2", root: "root2", styles: {} } },
            {
                surfaceUpdate: {
                    surfaceId: "surface-1",
                    components: [{ id: "root1", text: { literalString: "Surface 1" } }],
                },
            },
            {
                surfaceUpdate: {
                    surfaceId: "surface-2",
                    components: [{ id: "root2", text: { literalString: "Surface 2" } }],
                },
            },
        ];
        processor.processMessages(messages);
    ...
    it("should clear surfaces when clearSurfaces is called", () => {
        ...
        const messages = [
            { beginRendering: { surfaceId, root: "root", styles: {} } },
            {
                surfaceUpdate: {
                    surfaceId,
                    components: [{ id: "root", text: { literalString: "Test" } }],
                },
            },
        ];
        processor.processMessages(messages);
...
//# sourceMappingURL=A2UIMessageRenderer.test.js.map