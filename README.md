...
A proof-of-concept chat application demonstrating the integration of CopilotKit, LangChain agents, and A2UI for dynamic UI generation powered by Claude or Gemini LLM.
...
- **LLM**: Claude or Gemini with structured outputs
...
│  - Claude or Gemini LLM with structured outputs                   │
...
- **Gemini (Google)**: LLM with structured outputs
...
GOOGLE_API_KEY=your-api-key-here      # Your Google API key
LLM_PROVIDER=google or anthropic                  #Default LLM to use
